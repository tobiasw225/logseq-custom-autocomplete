...
declare class LSPluginCaller extends EventEmitter {
    ...
    callUserModel(type: string, ...args: any[]): Promise<any>;
    callUserModelAsync(type: string, ...args: any[]): Promise<any>;
    /**
     ...
     */
    private _applyContainerLayout;
    _setupIframeSandbox(): Promise<void>;
