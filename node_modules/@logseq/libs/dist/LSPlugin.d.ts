...
export type IUserConditionSlotHook<C = any, E = any> = (condition: C, callback: (e: IHookEvent & UISlotIdentity & E) => void) => void;
...
export type SlashCommandActionCmd = 'editor/input' | 'editor/hook' | 'editor/clear-current-slash' | 'editor/restore-saved-cursor';
...
export type BlockCommandCallback = (e: IHookEvent & {
    uuid: BlockUUID;
}) => Promise<void>;
...
export interface IEditorProxy extends Record<string, any> {
     ...
     * @param opts
     */
    insertBlock: (srcBlock: BlockIdentity | EntityID, content: string, opts?: Partial<{
        before: boolean;
        sibling: boolean;
        start: boolean;
        end: boolean;
    ...
    updateBlock: (srcBlock: BlockIdentity | EntityID, content: string, opts?: Partial<{
        properties: {};
    }>) => Promise<void>;
    ...
    setBlockCollapsed: (srcBlock: BlockIdentity | EntityID, opts: {
        flag: boolean | 'toggle';
    ...
    createTag: (tagName: string, opts?: Partial<{
        uuid: string;
        tagProperties: Array<{
            name: string;
    ...
    getPreviousSiblingBlock: (srcBlock: BlockIdentity | EntityID) => Promise<BlockEntity | null>;
    getNextSiblingBlock: (srcBlock: BlockIdentity | EntityID) => Promise<BlockEntity | null>;
    ...
    upsertProperty: (key: string, schema?: Partial<PropertySchema>, opts?: {
        name?: string;
    }) => Promise<IEntityID>;
    removeProperty: (key: string) => Promise<void>;
    upsertBlockProperty: (block: BlockIdentity | EntityID, key: string, value: any, options?: Partial<{
        reset: boolean;
    }>) => Promise<void>;
